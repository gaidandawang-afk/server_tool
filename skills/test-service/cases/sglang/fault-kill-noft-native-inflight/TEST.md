...
Validate `codex/ft-self-pause-minimal-simplify` with fault tolerance disabled. One stream runs on DP0 while DP1 is killed. Mooncake must isolate the dead peer
