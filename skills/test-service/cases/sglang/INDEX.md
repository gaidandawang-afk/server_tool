...
| Kill the DP1 leader when attention TP is greater than one | `fault_tpgt1_sibling_ep_retention.sh` | `fault-tpgt1-sibling-ep-retention` | DP1 route closure, DP0 continuation, rank3 process retention | Implemented with clarified core contract; runtime validation pending |
