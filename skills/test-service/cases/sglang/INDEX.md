...
| Lose and rejoin a logical node with pause | `fault_kill_pause_scale_down_then_rejoin.sh` | `fault-kill-pause-scale-down-then-rejoin` | pause, inactive recover, rejoin | Validated once on `74cafe36617c75f18b39d973486575b080360fd7`; one retained intermittent fallback-collective failure remains unresolved; see [revise validation record](VALIDATION-2026-07-30-REVISE.md) |
