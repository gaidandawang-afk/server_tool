...
| Lose and rejoin a logical node with pause | `fault_kill_pause_scale_down_then_rejoin.sh` | `fault-kill-pause-scale-down-then-rejoin` | pause, inactive recover, rejoin | Current static/deterministic contract has the same data-plane FAIL on `7f553fee0991e90566ac9c173eae89d9b2c52609` and `74cafe36617c75f18b39d973486575b080360fd7`; see [revise validation record](VALIDATION-2026-07-30-REVISE.md) |
