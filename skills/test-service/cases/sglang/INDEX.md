...
| Kill one member of a TP sibling group | `fault_tpgt1_sibling_ep_retention.sh` | `fault-tpgt1-sibling-ep-retention` | TP>1 sibling retention and EP layout | FAIL on `edfdb26091a89b05de9e1c2ac7944a8c3c1fe138`: live-replica preservation was explicitly reverted by `f5e32a5e3`; source decision required |
